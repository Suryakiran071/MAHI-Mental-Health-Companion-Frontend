...
const ChatbotPage = () => {
  ...
  return (
    ...
    >
      ...
      {/* Sticky Header */}
      <div className="w-full max-w-6xl sticky top-0 bg-inherit z-10 py-4 flex justify-between items-center" style={{ position: 'relative', zIndex: 10 }}>
        <div>
          <h1 className="text-4xl font-bold">Your Mental Health Companion</h1>
      ...
      <div
        ...
        style={{ 
          position: 'relative', 
          zIndex: 10, 
          backgroundColor: darkMode ? 'rgba(31, 41, 55, 0.95)' : 'rgba(243, 244, 246, 0.95)' 
        }}
      >
        {/* Messages */}
            ...
            <div
              ...
              style={{
                ...
                backgroundColor: darkMode 
                  ? (message.sender === "AI" ? 'rgba(55, 65, 81, 0.9)' : 'rgba(55, 65, 81, 0.9)')
                  : (message.sender === "AI" ? 'rgba(229, 231, 235, 0.9)' : 'rgba(229, 231, 235, 0.9)')
              }}
            >
              <p>{message.text}</p>
            </div>
        ...
        <div
          ...
          style={{
            backgroundColor: darkMode ? 'rgba(55, 65, 81, 0.9)' : 'rgba(229, 231, 235, 0.9)'
          }}
        >
